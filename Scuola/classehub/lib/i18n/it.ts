...
export const it = {
  ...
  bacheca: {
    ...
    vistaAttiva: "Stai vedendo solo: {label}.",
    vistaMostraTutto: "Mostra tutto",
    apri: "Apri",
    vota: "Vota",
  ...
  dettaglio: {
    ...
    il: "il",
    vistoSegna: "L'ho visto",
    vistoTogli: "Visto — tocca per togliere",
    vistiTitolo: "Chi l'ha visto",
    vistiConteggio: "{n} genitori su {tot} l'hanno segnato come visto.",
    vistiConteggioUno: "1 genitore su {tot} l'ha segnato come visto.",
    vistiNessuno: "Nessuno l'ha ancora segnato come visto.",
    vistiMancano: "Non l'hanno ancora visto:",
    vistiTutti: "L'hanno visto tutti. 🎉",
  ...
  cassa: {
    ...
    // "Ho ricevuto soldi" e schermata di conferma
